  ...
  return (
    <main className="flex justify-center items-center h-screen bg-gray-200">
      <div className="flex w-[58rem] h-[22rem]">
        <Image style={{objectFit: "cover"}} src={drawers} alt="" className="w-96 rounded-l-2xl object-left" />
        <div className="bg-white h-full rounded-r-2xl flex justify-between items-center flex-col p-12">
          ...
          <div className="flex justify-between items-center w-full">
            <div className="flex justify-between items-center">
              ...
              <div className="bg-gray-200 rounded-3xl w-10 h-10 flex items-center justify-center pb-1 hover:bg-gray-800 cursor-pointer"
                onClick={() => mouseHover()}
              >
                <Tooltip visible={showTooltip} />
                <Image src={share} alt="Article" width={20} height={20}/>
              </div>
          </div>
        </div>
      </div>
